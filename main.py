...
while(True):
    choice = int(input("1. File Integrity Monitoring 2. Show number of webapps hosted 3. Show number of scans scheduled 4. Show number of reports generated 5. Show number of times scanned 6. Stop\nEnter choice: "))
    if choice==1:
        fim()
    elif choice==2:
